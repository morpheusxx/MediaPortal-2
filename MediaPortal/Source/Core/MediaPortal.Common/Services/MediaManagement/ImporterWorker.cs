  ...
  public class ImporterWorker : IImporterWorker, IDisposable
  {
        ...
        ICollection<IMetadataExtractor> metadataExtractors, IImportResultHandler resultHandler, IMediaAccessor mediaAccessor)
    {
      ...
      if (aspects == null)
        ...
        return false;
      resultHandler.UpdateMediaItem(parentDirectoryId, path, aspects.Values, null);
        ...
        IMediaBrowsing mediaBrowsing, IImportResultHandler resultHandler)
    {
      ...
      { // Add directory item to ML
        ...
        return resultHandler.UpdateMediaItem(parentDirectoryId, directoryPath, aspects, null);
      }

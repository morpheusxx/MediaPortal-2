...
namespace MediaPortal.Common.MediaManagement
{
  public interface IImportResultHandler
  {
    ...
    Guid UpdateMediaItem(Guid parentDirectoryId, ResourcePath path, IEnumerable<MediaItemAspect> updatedAspects, IEnumerable<MediaItemRelationship> updatedRelationships);

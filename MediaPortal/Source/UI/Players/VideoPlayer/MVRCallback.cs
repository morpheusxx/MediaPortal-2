...
namespace MediaPortal.UI.Players.Video
{
  ...
  public interface IMVRPresentCallback
  {
    ...
    [PreserveSig]
    void GrabScreenshot(IntPtr pTargetmadVrDib);

    [PreserveSig]
    void GrabCurrentFrame(IntPtr pTargetmadVrDib);
  ...
  {
    public int PresentImage(short cx, short cy, short arx, short ary, uint pImage, uint pTexture)
    {
      return 0;
    }
    ...
    public int RenderGui(short cx, short cy, short arx, short ary)
    {
      return 0;
    }

    public int RenderOverlay(short cx, short cy, short arx, short ary)
    {
      return 0;
    }
    ...
    public void GrabScreenshot(IntPtr pTargetmadVrDib)
    {

    }

    public void GrabCurrentFrame(IntPtr pTargetmadVrDib)
    {
